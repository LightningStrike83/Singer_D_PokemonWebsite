...
<body>
    <div id="container">
        <div id="full-length" class="full-width-grid-con">
            ...
            <div id="logo-con" class="col-start-2 col-end-4 m-col-span-full">
              <a href="../index.php"><svg id="main-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 288.92 65.92">
                <defs>
                  <style>
                    .cls-4 {
                      fill: #fff;
    ...
    <section id="login-con" class="grid-con">
        <form id="login-home" action="login.php" method="post" class="col-span-full">

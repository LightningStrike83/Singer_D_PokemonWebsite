...
let silver1GGSC = document.querySelector("#silver1_g")
let silver1FGSC = document.querySelector("#silver1_f")
let silver1WGSC = document.querySelector("#silver1_w")
...
function showPokemonGSCImages(trainerId) {
    ...
    refCredit.textContent = "Eevee-trainer"
    refCredit.href = "https://gamefaqs.gamespot.com/gbc/375087-pokemon-crystal-version/faqs/75486/full-trainer-info-list"
}
...
silver1GGSC.addEventListener('click', displayGSCTrainers);
silver1FGSC.addEventListener('click', displayGSCTrainers);
silver1WGSC.addEventListener('click', displayGSCTrainers);

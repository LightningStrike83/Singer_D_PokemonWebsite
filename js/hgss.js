...
let silver2GHGSS = document.querySelector("#silver2_g")
let silver2FHGSS = document.querySelector("#silver2_f")
let silver2WHGSS = document.querySelector("#silver2_w")
...
function showPokemonHGSSImages(trainerId) {
    ...
    refCredit.href = "https://www.speedrun.com/pkmnhgss/guides/k2zij"
}
...
silver2GHGSS.addEventListener('click', displayHGSSTrainers);
silver2FHGSS.addEventListener('click', displayHGSSTrainers);
silver2WHGSS.addEventListener('click', displayHGSSTrainers);
